...
#define LV_DEF_REFR_PERIOD  30 //33      /*[ms]*/
...
#define LV_FONT_MONTSERRAT_24 2
...
#define LV_USE_BIDI 0  //if enabled, might give a warning about an uninitialized length variable in lv_label.c
#if LV_USE_BIDI
