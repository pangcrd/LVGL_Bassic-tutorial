...
/////////////////////////////////////////////////////////////////////////////
//                                                                         //
// Example CYD  ESP32-2432S028R [Switch Widget + LED with some image]      // 
...
#define NUM_LED  2   // Number LED [Number of led = 2][Meaning value run 0 to 1] [when value = 0 GPIO =>22. When value = 1 GPIO => 27]
int led_pins[NUM_LED] = {22,27};  // LED Gpio
...
void led_update_cb(lv_timer_t * timer) {
  // Update the LED status according to the corresponding switch.
   digitalWrite(led_pins[0], switch_states[1] ? HIGH : LOW);
   digitalWrite(led_pins[1], switch_states[2] ? HIGH : LOW);
