...
void ui_Screen1_screen_init(void)
{
    ...
    lv_label_set_text(ui_Label1, "MAIN SCREEN");
    lv_obj_set_style_text_color(ui_Label1, lv_color_hex(0xFF1818), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui_Button1, lv_color_hex(0xF767FB), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui_Button2, lv_color_hex(0xF767FB), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_Label2, "PAGE 1");
    lv_obj_set_style_text_color(ui_Label2, lv_color_hex(0x4400FF), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui_Label3, lv_color_hex(0x4400FF), LV_PART_MAIN | LV_STATE_DEFAULT);
