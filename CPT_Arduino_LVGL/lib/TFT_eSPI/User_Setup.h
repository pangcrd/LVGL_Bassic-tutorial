...
// sketch. e.g. with digitalWrite(TFT_BL, LOW);
 ...
 #define TFT_BL   11            // LED back-light control pin
...
#define TFT_SCLK  12  // Automatically assigned with ESP8266 if not defined

#define TFT_CS    15  // Chip select control pin D8Z
...
// For the RP2040 processor define the SPI port channel used (default 0 if undefined)
 #define TFT_SPI_PORT 2// Set to 0 if SPI0 pins are used, or 1 if spi1 pins used
